...
const ShowTeachers = () => {
    ...
    const deleteHandler = (deleteID, address) => {
        dispatch(deleteUser(deleteID, address)).then(() => {
            setMessage("Teacher deleted successfully!"); // Set success message
            setShowPopup(true); // Show popup
            dispatch(getAllTeachers(currentUser._id)); // Refresh the list
        }).catch(err => {
            setMessage("Error deleting teacher!"); // Set error message
            setShowPopup(true); // Show popup
        });
    };
